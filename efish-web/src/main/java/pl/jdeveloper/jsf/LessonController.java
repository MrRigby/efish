package pl.jdeveloper.jsf;

import pl.jdeveloper.entities.Lesson;
import pl.jdeveloper.jsf.util.JsfUtil;
import pl.jdeveloper.jsf.util.PaginationHelper;
import pl.jdeveloper.sfacade.LessonFacade;
...
public class LessonController implements Serializable {
    ...
    @EJB
    private pl.jdeveloper.sfacade.LessonFacade ejbFacade;
